...
dataset_type="val"
if MACHINE=='pc':
	IMAGE_ROOT='/media/yves/sandisk3/datasets/coco/images/'+dataset_type+'2014'
	COCO_PATH = 'media/yves/sandisk3/datasets/coco'
else:
	IMAGE_ROOT='/Users/yves/Documents/coco/images/'+dataset_type+'2014'
...
def read(coco):
	...
	num_missing = 0
	num_captions = 0
	outfile=open('coco-caption-'+dataset_type+'.txt','w')
